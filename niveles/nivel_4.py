...
class Nivel_4(Nivel):
    def __init__(self):
        ...
        #FONDO
        fondo = pg.image.load(h.map_4)
        fondo = pg.transform.scale(fondo, c.TAMAÑO_PANTALLA)
        piso = h.piso_map_4

        ### SE CREAN TODAS LAS PLATAFORMAS
        isla_3 = Mini_isla(c.ANCHO//2, c.ALTO//2 + 120, pg.Rect(0,0, 200, 20), h.isla1)
        isla_1 = Mini_isla(0, c.ALTO * 1/4 , pg.Rect(0,0, 900, 40), h.isla1)
        isla_2 = Mini_isla(c.ANCHO, c.ALTO * 1/4, pg.Rect(0,0, 900, 40), h.isla1)
        isla_4 = Mini_isla(c.ANCHO, 500, pg.Rect(0,0, 500, 30), h.isla1)
        isla_5 = Mini_isla(0, 500, pg.Rect(0,0, 500, 30), h.isla1)
